...
<form action="" method="post" id="form-courses">
    ...
    <div class="row" id="lesson-form">
        <div class="col-6 mb-3 group-control">
            ...
            <input type="text" class="form-control" name="name" id="name" placeholder="Enter lesson name ..." required>
        </div>
        <div class="col-6 mb-3 group-control">
        ...
        <div class="col-4 mb-3 group-control">
            ...
            <select class="form-control select2" name="parent_id">
                ...
                {{splitLesson($lessons, request()->module)}}
            </select>
        </div>
        ...
        <div class="col-2 mb-3 group-control">
        ...
        <div class="col-6 mb-3">
            ...
            <div class="input-group">
                <input type="text" class="form-control" name="video" id="video-url" placeholder="Video ..."> 
        ...
        <div class="col-6 mb-3">
            ...
            <div class="input-group">
                <input type="text" class="form-control" name="document" id="document-url" placeholder="Document ..."> 
